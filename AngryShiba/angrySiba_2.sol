...
contract ANSH is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xE6645A925B463ebca7ded0667eeFB94b5fd64D43); 
    address payable public developmentAddress = payable(0xfe4E2C9A453454e911A31C5DBb5eeB2f30099489); 
    address payable public charityAddress = payable(0xfDC4d0ce64A3105aC7075be7D3ABCE5883cc4F26); 
    address payable public vaultRewardAddress = payable(0x318be3e4aaa447735d23F53727aF5227FC8fDBDD); 
    ...
    //Create additional liquidity using ANSH tokens in contract
